...
public class PassengerController {
    ...
    public Passenger getPassengerByPassengerId(@PathVariable Long passenger_id){
        return passengerService.getPassengerByPassengerId(passenger_id);
    }

    @PutMapping("passenger/id/{passenger_id}")
    public Passenger updatePassengerByPassengerId(@PathVariable Long passenger_id, @RequestBody Passenger updatedPassenger){
    ...
    public void deletePassengerByPassengerId(@PathVariable Long passenger_id){
    ...
    public List<Aircraft> getAllAircraftAPassengerHasTravelledOn(@PathVariable Long passengerId){
    ...
    public List<Airport> getAllAirportsAPassengerHasUsed(@PathVariable Long passengerId){
